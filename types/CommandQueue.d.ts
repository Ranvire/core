...
declare class CommandQueue {
    ...
    flush(): void;
    /**
     * Completely reset the queue and unknown lag. This is fairly dangerous as if the
     * player could reliably reset the queue they could negate unknown command lag. To
